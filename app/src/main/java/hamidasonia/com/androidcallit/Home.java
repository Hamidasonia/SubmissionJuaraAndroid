...
import hamidasonia.com.androidcallit.Model.Category;
import hamidasonia.com.androidcallit.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               Intent cartIntent = new Intent(Home.this,LoginMail.class);
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent menusList = new Intent(Home.this, MenusList.class);
                        //Because category is key , so we just get key of this item
                        menusList.putExtra("CategoryId", adapter.getRef(position).getKey());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Intent email = new Intent(Home.this,LoginMail.class);
            startActivity(email);
